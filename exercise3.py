...
class Rectangle:
    ...
    # def contains(self, point: Point2D) -> bool:
        ...
        return is_in_interval(ll_px, 0.0, self._dx, tolerance) and is_in_interval(ll_py, 0.0, self._dy, tolerance) # Task A
...
def is_in_interval(value: float, lower_bound: float, upper_bound: float, tolerance: float) -> bool: # Task A
